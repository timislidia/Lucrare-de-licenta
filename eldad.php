...
<section id="meniu">
   ...
   include "conectare.php";
	...
	<p> Harfa lui David</p>
	<div class="fbuttons">
		<a href="cantece.php" class="button">Cântece creștine</a>&nbsp;&nbsp;
	...
	<div class="buttons">
		...
		<?php
		$resultSet = $mysqli->query("SELECT id_resursa FROM resurse");
        $numRows = $resultSet->num_rows;
        $resultSet = $mysqli->query("SELECT * FROM resurse WHERE autor='Eldad' ");
